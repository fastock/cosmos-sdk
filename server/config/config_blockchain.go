...
var defaultNodeHome = os.ExpandEnv("$HOME/.fastock-chain-daemon")
...
type BackendOrmEngineInfo struct {
	...
	// if engine_type is sqlite3, it should be a local path, e.g.) /Users/lingting.fu/.fastock-chain-daemon/data/sqlite3/backend.db
